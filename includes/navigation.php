        ...
        <nav class="navbar navbar-expand-lg navbar-dark justify-content-between">
            ...
            <div class="collapse navbar-collapse" id="main">
                <ul class="navbar-nav ml-5 ">
                    <li class="nav-item"><a href="../media/index.php" class="nav-link">HOME</a></li>
                    ...
                    <li class="nav-item dropdown"><a href="" class="nav-link" data-toggle="dropdown">
                        ...
                        <div class="dropdown-menu bg-dark">
                            <a href="videos.php" class="dropdown-item">ALL VIDEOS</a>
                            ...
                            <?php
                                ...
                                while ($row=mysqli_fetch_assoc($select_categories)){
                                    ...
                                    $cat_id= $row['cat_id'];
                                    echo "<a href='video_cat.php?v_cat={$cat_id}' class='dropdown-item'>{$cat_title}</a>";
                                }
